...
listener http:Listener httpListenerUnsecured = new (9091);

// Type driven query
type ScheduledVisitEntityUnsecured record {|
    int id;
    record {|
        int visitId;
        string houseNo;
...
type ActualVisitEntityUnsecured record {|
    int id;
    record {|
        int visitId;
        string houseNo;
...
service /visit on httpListenerUnsecured {
...
function dateNowUnsecured() returns time:Date {
...
function createScheduleVisitUnsecured(int visitId, string houseNo, string visitorName,
